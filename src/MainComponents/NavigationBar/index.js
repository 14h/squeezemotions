...
export default class NavigationBar extends Component {
	...
	componentDidMount(){
		...
		if(document.getElementById("Main-NavigationBar-component")){
	...
	render() {
		let colorScheme = this.props.wedding ? ('#bfa568') : ('green')
			...
			<div id="Main-NavigationBar-component"  className={this.props.wedding ? ('wedding'): ('main')}>
					<Link className="logo" to="/" >
								<svg width="160px" height="45px" viewBox="0 0 800 250" xmlns="http://www.w3.org/2000/svg">
									...
									<text x="-57.073813" y="-750.918384" id="svg_8" fontSize="178.1876" fontFamily="'BlenderPro-Bold'" fill="#262628" transform="matrix(1,0.00143,-0.00143,1,277.9696,931.6473) ">{this.props.logoText || 'UEEZE'}</text>
									<line  strokeMiterlimit="10" strokeWidth="7" fill="#262628" stroke="none" y2="201" x2="682" y1="202" x1="249"/>
								</svg>
								{/* <svg width="160px" height="45px" viewBox="0 0 1100 250" xmlns="http://www.w3.org/2000/svg">
				...
				<div id="Main-NavigationBar">
					...
					<div className="nav-list">
						<div className="nav-list-row">
							...
							>BLOG
							<div  className={this.props.wedding ? ('wedding  nav-list-item-dot'): ('main  nav-list-item-dot' +blogSelectedClass)}/>
							</Link>
					...
					<div className='nav-overlay' >
						<div className="nav2">
							<Link className="nav2-elem" onClick={()=>{this.toggleNavOverlay();this.toggleNavOverlayInput()}} to="/">Überblick</Link>
