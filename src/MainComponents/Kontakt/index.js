			...
			// <Draggable axis="y" onStop={(event)=>this.handleStop(event)} bounds= {{ top: -window.visualViewport.height*0.825,bottom: 0}} >
				<div id="Kontakt" style={this.state.KontaktStyle}>	
					<div className="Footer" style={this.state.FooterStyle} onClick={()=>this.switchOpenCloseKontakt(0)}>
						<svg style={{transform: 'translate(0, -10px)'}} width="225px" height="45px" viewBox="0 0 920 250" xmlns="http://www.w3.org/2000/svg">
					...
					{/* {this.state.KontaktIsOpen && <NavigationBar style={{zIindex:30}}  wedding={false} logoText="CLOSE" selectedNav="creativeproducer"/>} */}
					<ContactForm />
				</div>	
			// {/* </Draggable> */}
